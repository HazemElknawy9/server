                ...
                <div style="border-radius: 9px !important;-webkit-box-shadow: 0 0 2rem 0 rgba(136,152,170,.15) !important;" class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            <i class="icon-plus"></i>
                            <span class="caption-subject bold uppercase"> تعديل منتجات</span>
                        </div>
                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select  name="vendor_id" class="bs-select form-control input-lg" data-live-search="true" data-size="8">
                                            ...
                                            @foreach ($vendors as $vendor)
                                                <option value="{{ $vendor->id }}" {{ $product->vendor_id == $vendor->id ? 'selected' : '' }}>{{ $vendor->first_name }}</option>
                                            @endforeach
                                        </select>
                                        @error('vendor_id')
                                        <span class="text-danger">{{$message}}</span>
                                ...
                                <div class="row">
                                   <div class="col-md-12">
                                      <div class="form-group">
                                          ...
                                          <input style="border-radius: 6px !important;height: 46px;" type="text" name="name" value="{{$product->name}}" class="form-control input-lg" placeholder=''> 
                                      </div>
                                      @error('name')
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                ...
                                <div class="row">
                                   <div class="col-md-12">
                                      <div class="form-group">
                                          ...
                                          <div class="col-md-12">
                                           <textarea style="margin: 0px -13px 12px -14px;width: 1028px;height: 50px;" name="description" id="description" class="form-control">{{$product->description}}</textarea>
                                          </div>
                                      </div>
                                      @error('description')
                                        <span class="text-danger">{{$message}}</span>
                                ...
                                <div class="row">
                                   <div class="col-md-4">
                                      <div class="form-group">
                                          ...
                                          <input style="border-radius: 6px !important;height: 46px;" type="number" name="price" value="{{$product->price}}" class="form-control input-lg" placeholder=''> 
                                      </div>
                                      @error('price')
                                        <span class="text-danger">{{$message}}</span>
                                      @enderror
                                    ...
                                    <div class="col-md-4">
                                      <div class="form-group">
                                          ...
                                          <input style="border-radius: 6px !important;height: 46px;" type="number" value="{{$product->minimum_price}}" name="minimum_price" class="form-control input-lg" placeholder=''> 
                                      </div>
                                      @error('minimum_price')
                                        <span class="text-danger">{{$message}}</span>
                                      @enderror
                                    ...
                                    <div class="col-md-4">
                                      <div class="form-group">
                                          ...
                                          <input style="border-radius: 6px !important;height: 46px;" type="number" value="{{$product->maximum_price}}" name="maximum_price" class="form-control input-lg" placeholder=''> 
                                      </div>
                                      @error('maximum_price')
                                        <span class="text-danger">{{$message}}</span>
                                      @enderror
                                ...
                                <div class="row">
                                   <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <input style="border-radius: 6px !important;height: 46px;" type="number" name="stock" value="{{$product->stock}}" class="form-control input-lg" placeholder=''> 
                                      </div>
                                      @error('stock')
                                        <span class="text-danger">{{$message}}</span>
                                      @enderror
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group">
                                          <i class="fa fa-clock-o"></i>
                                          <label>العمولة</label>
                                          <input style="border-radius: 6px !important;height: 46px;" type="number" name="commission" value="{{$product->commission}}" class="form-control input-lg" placeholder=''> 
                                      </div>
                                    </div> 
                                </div>
                                <div class="row">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail" style="max-width: 100%; height: 150px;">
                                                <img src="{{ Storage::disk('public')->url('products_image/'.$product->image) }}" alt="" /> </div>
