                ...
                <div style="border-radius: 9px !important;-webkit-box-shadow: 0 0 2rem 0 rgba(136,152,170,.15) !important;" class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            <i class="icon-plus"></i>
                            <span class="caption-subject bold uppercase"> تعديل Faqs</span>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                   <div class="col-md-12">
                                      <div class="form-group">
                                          ...
                                          <input style="border-radius: 6px !important;height: 46px;" type="text" name="question" value="{{$faq->question}}"  class="form-control input-lg" placeholder=''> 
                                      </div>
                                      @error('question')
                                ...
                                <div class="row">
                                   <div class="col-md-12">
                                      <div class="form-group">
                                          ...
                                          <div class="col-md-12">
                                           <textarea style="margin: 0px -13px 12px -14px;width: 1028px;height: 50px;" name="answer" id="answer"  class="form-control">{{$faq->answer}}</textarea>
                                          </div>
                                      </div>
                                      @error('answer')
                                        <span class="text-danger">{{$message}}</span>
