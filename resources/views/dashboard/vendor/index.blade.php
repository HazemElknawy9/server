    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="{{asset('dashboard/vendors')}}">لموردين</a>
                    <i class="fa fa-angle-double-left"></i>
                </li>
                <li>
                    <span>عرض</span>
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{{ route('dashboard.vendors.create') }}" class="btn sbold green"><i class="fa fa-plus"></i> اضافة مورد جديد</a>
                                    </div>
                                </div> 
                            </div>
                        </div>
  ...
  columns:[
   ...
   },
   {
    ...
    render: function(data, type, full, meta){
     return "<img style='height: 60px;' src={{ URL::to('/') }}/storage/vendor_profile/" + data + " width='70' class='img-thumbnail' />";
    },
    orderable: false
   },
