...
fetch_data();
 ...
 $('#sample').DataTable({
  ...
  serverSide: true,
  ajax:{ 
   url: "{{ route('dashboard.category.products', ['category_id' => $_GET['category_id']]) }}",
  ...
  columns:[
   ...
   },
   {
    ...
    render: function(data, type, full, meta){
     return "<img style='height: 60px;' src={{ URL::to('/') }}/storage/products_image/" + data + " width='70' class='img-thumbnail' />";
    },
    orderable: false
   },
